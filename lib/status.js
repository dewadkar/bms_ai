                            ...
                            for (var i = 0; i < data.length; i++) {
                                if (data[i].device_id.includes('1')) {
                                    type_a_json.push({
                                        ...
                                        "device_type": "TYPE-A",
                                        "failure_risk": randomDataSet(100, 1, 99),
                                        "health_score": randomDataSet(100, 1, 100),
                                        "remaining_useful_life": randomDataSet(100, 1, 100),
                                        "temperature_humidity": randomDataSet(100, 1, 100),
                                ...
                                if (data[i].device_id.includes('3')) {
                                    type_c_json.push({
                                        "device_id": data[i].device_id,
                                        "device_type": "TYPE-C",
                                        "failure_risk": randomDataSet(30, 1, 100),
                                        "health_score": randomDataSet(30, 1, 100),
